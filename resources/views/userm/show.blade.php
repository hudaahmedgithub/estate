  ...
  <div class="container">
   ...
   <!-- <div class="col-md-3" style="float:right">-->
	...
	<div class="col-md-6 shadow" >
		...
		<div class="badge" style="background:#5fccb4">{{$bu->country->name}}</div>
        ...
        <a class="banner_btn" href="{{route('show',$bu->id)}}"style="background:#f90">Show</a>
		
		<a class="banner_btn" href="{{route('muser.edit',$bu->id)}}"style="background:#f90">Edit</a>
